...
/**
 * swap_ints - integers in an array.
 * @a: The first integer
...
/**
 * bitonic_merge - inside an array of integers.
...
/**
 * bitonic_seq - integers into a bitonic sequence.
 * @array: An array of integers.
 * @size: The size of the array.
 * @start: The starting index of a block of the building 
...
/**
 * bitonic_sort - integers in ascending
 * @array: An array of integers.
 * @size: The size of the array.
